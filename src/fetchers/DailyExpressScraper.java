...
public class DailyExpressScraper extends ReactiveScraper {
	...
	// search results on one page. Due to the fact that even on that page, a
	...
	// If that's not the case, null is returned, signaling that all results have
	...
	protected String getNextSearchURL(Document doc) {
		...
		// Get keyword and number of results for URL construction, set
		// this.fetched
		this.fetched = true;
