...
public abstract class Fetcher {
	 ...
	 * {@code set} by calling the
	 * {@link framework.articles.Article#populateData()} method on each article.
	 * 
	 * @param articles
	...
	protected Map<String, Article> processArticles(Map<String, Article> articles, Date fromDate,
		...
		// Filter articles by URL in order not to populate undesired
		// articles
		// (save network calls)
		...
		this.log.fine("Number of articles before PostPopulatingFilter: "
				+ articles.size());
	 ...
	 * {@link framework.filters.URLSuffixFilter}.
	 * 
	 * @param articles
	 ...
	 * Returns a {@link java.util.Set} of {@link framework.articles.Article}
	 * elements matching the above conditions.
	 * 
	 * @param keywords
	 ...
	 *            returned
	 * @return a Map of {@link framework.articles.Article} objects representing
	 *         newspaper articles mapped to their url
	 */
